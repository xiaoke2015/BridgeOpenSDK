...
Pod::Spec.new do |spec|
  ...
  spec.name         = "BridgeOpenSDK"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of BridgeOpenSDK."

  spec.description  = <<-DESC
                  BridgeOpenSDK
                    DESC

  spec.homepage = "https://github.com/xiaoke2015/BridgeOpenSDK.git"
